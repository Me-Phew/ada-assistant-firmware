...
namespace esphome
{
  namespace micro_wake_word
  {
    ...
    public:
      ...
      void set_microphone(ada_assistant::microphone_driver::AdaMicrophoneDriver *microphone)
      {
    ...
    protected:
      ada_assistant::microphone_driver::AdaMicrophoneDriver *microphone_{nullptr};
